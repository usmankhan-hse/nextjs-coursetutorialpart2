  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white px-4">
      <div className="w-full max-w-md border-2 border-white rounded-2xl p-8 shadow-lg">
        ...
        >
          <label htmlFor="pic">
            <div className="w-25 h-25 rounded-full border-2 flex justify-center items-center border-white transition-all hover:border-blue-500 text-white hover:text-blue-500 cursor-pointer overflow-hidden relative ">
              <input
                type="file"
                accept="image/*"
                hidden
              ...
              />
              {backendImage ? (
                <Image fill src={URL.createObjectURL(backendImage)} alt="" />
              ) : frontendImage ? (
